...
async function update() {
  ...
  worker = new Worker('tinygo/worker/webworker.js');
...
document.addEventListener('DOMContentLoaded', async function(e) {
  ...
  updateBoards().then(function (res) {
    return true;
  }, function (err) {
    return false;
  }).catch(function (err) {
  ...
  setProject(localStorage.tinygo_playground_projectName || defaultProjectName).then(function (res) {
    return true;
  }, function (err) {
    return false;
  }).catch(function (err) {
