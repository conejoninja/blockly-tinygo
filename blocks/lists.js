...
Blockly.Blocks['lists_string_create_with'] = {
  /**
  ...
  updateShape_: function() {
    ...
    for (var i = 0; i < this.itemCount_; i++) {
       if (!this.getInput('ADD' + i)) {
        ...
        .setCheck("String") // ESTA LINEA ES LA MAGIA
        //.setCheck("Number") // ESTA LINEA ES LA MAGIA
        //.setCheck("Colour") // ESTA LINEA ES LA MAGIA
        .setAlign(Blockly.ALIGN_RIGHT);
        if (i == 0) {
          input.appendField('create string list with');
        }
      }
    }
...
Blockly.Blocks['lists_number_create_with'] = {
  /**
   * Block for creating a list with any number of elements of any type.
   * @this {Blockly.Block}
   */
  ...
  updateShape_: function() {
    ...
    for (var i = 0; i < this.itemCount_; i++) {
       if (!this.getInput('ADD' + i)) {
        ...
        .setAlign(Blockly.ALIGN_RIGHT);
        if (i == 0) {
          input.appendField('create number list with');
        }
      }
    }
    // Remove deleted inputs.
...
Blockly.Blocks['lists_colour_create_with'] = {
  /**
   * Block for creating a list with any number of elements of any type.
   * @this {Blockly.Block}
   */
  ...
  updateShape_: function() {
    ...
    for (var i = 0; i < this.itemCount_; i++) {
       if (!this.getInput('ADD' + i)) {
        ...
        .setAlign(Blockly.ALIGN_RIGHT);
        if (i == 0) {
          input.appendField('create colour list with');
        }
      }
    }
    // Remove deleted inputs.
